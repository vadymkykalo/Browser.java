...
public class FirefoxTest {
    ...
    public void setUp() throws Exception {
        ...
        File file = new File(classLoader.getResource("firefox.txt").getFile());
    ...
    @DataProvider
    public Object[][] getFirefoxData() {
        return entries.toArray(new Object[entries.size()][]);
    }

    @Test(dataProvider = "getFirefoxData")
    public void testFirefoxUserAgent(String userAgent, String type, String browserName, String version) {
