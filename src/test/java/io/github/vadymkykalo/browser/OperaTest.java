...
public class OperaTest {
    ...
    public void setUp() throws Exception {
        ...
        File file = new File(classLoader.getResource("opera.txt").getFile());
    ...
    @Test(dataProvider = "getOperaData")
    public void testOperaUserAgent(String userAgent, String type, String browserName, String version) {
